...
<head>
    ...
    <script>
        ...
        function validar() {
            ...
            if (nombre == '' || apellidos == '' || correo == '' || pass == '' || rol == 0 || archivo.files.length <= 0) {
                ...
                document.Forma1.action = 'empleados_salva.php';
...
<div class="escritura">Alta de empleados<br><hr></div><br>
